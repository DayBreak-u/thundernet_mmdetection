// adapted from "psroi_align_ave" in RoITransformer "https://github.com/dingjiansw101/RoITransformer_DOTA/blob/master/fpn/operator_cxx/psroi_align_ave.cu"
#include <ATen/ATen.h>
    ...
    for (int iy = 0; iy < roi_bin_grid_h; iy++) {  // e.g., iy = 0, 1
      ...
      for (int ix = 0; ix < roi_bin_grid_w; ix++) {
        ...
        scalar_t val = bilinear_interpolate<scalar_t>(
            offset_bottom_data, height, width, yy, xx, index);
        output_val += val;
      }
    }
